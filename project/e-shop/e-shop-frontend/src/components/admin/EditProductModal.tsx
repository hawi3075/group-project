...
// Define the Product type (same as in ProductsPage)
export type Product = {
  id: string
  name: string
  color: string
...
// Define the props for the EditProductModal
...
// Form data type (matches product but without id and with optional sizes)
type FormDataType = {
  name: string
  classification: string
  color: string
...
export function EditProductModal({ product, isOpen, onClose, onSubmit }: EditProductModalProps) {
